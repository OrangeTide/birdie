...
birdie_SRCS  = main.c \
	bd_net.c bd_ring.c bd_telopt.c bd_encoding.c bd_csv.c bd_profile.c bd_session.c \
	bd_vm.c bd_trigger.c bd_verb.c bd_vm_lua.c bd_log.c bd_replay.c bd_mxp.c bd_mcp.c
