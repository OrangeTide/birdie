 ...
 *
 * Implemented: #action, #alias, #class, #script. The line-rewriting verbs
 * (#substitute / #gag / #highlight), the timer verb (#tick), the remove/list
 * verbs (#unaction / #list), and a configurable command char are deferred
 * (doc/triggers.md).
 *
