...
curl -fsSL https://raw.githubusercontent.com/OrangeTide/birdie/main/scripts/get-birdie-gui.sh \
    | sh -s -- 0.4.2 third_party/birdie-gui
```

That vendors birdie-gui 0.4.2 into `third_party/birdie-gui/`. Re-run it with a
...
```sh
scripts/get-birdie-gui.sh 0.4.2            # into third_party/birdie-gui by default
